 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
	...
	for (size_t t = 0; t < N-1; t++) {
	  ...
	  AD<double> f0 = coeffs[0] + coeffs[1] * x0 + coeffs[2] * x0 * x0 + coeffs[3] * x0 * x0 * x0;//coeffs[0] + coeffs[1] * x0;
	  AD<double> psides0 = CppAD::atan(3*coeffs[3]*x0*x0 + 2*coeffs[2]*x0 + coeffs[1]); //CppAD::atan(coeffs[1]);
